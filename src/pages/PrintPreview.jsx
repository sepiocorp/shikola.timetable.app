...
import { Button, Card, PageHeader, Select, Badge } from '../components/UI.jsx'
          ...
          <PageHeader
            ...
            action={
              <div className="flex items-center gap-3">
                <Button onClick={handlePrint} disabled={!selectedId}>
      ...
      {!selectedId ? (
        <Card className="p-6 print:hidden">
          <div className="text-center py-12">
            <p className="text-sm text-slate-500">Select a {viewType === 'class' ? 'class' : 'teacher'} to preview the timetable</p>
          </div>
        </Card>
      ) : (
